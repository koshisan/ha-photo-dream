...
class PhotoDreamBaseNumber(NumberEntity):
    """Base class for PhotoDream number entities."""
...
class PhotoDreamPanSpeedNumber(PhotoDreamBaseNumber):
    """Number entity for pan speed on a PhotoDream device."""
...
class PhotoDreamClockFontSizeNumber(PhotoDreamBaseNumber):
